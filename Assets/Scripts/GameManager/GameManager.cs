...
public class GameManager : SingletonMonobehaviour<GameManager>
{
    ...
    protected override void Awake()
    {
        ...
        //Fix
        player = C_Data.Instance.character;
    ...
    public void NextLevel(bool isGenerated)
    {
        if(!isGenerated)
        {
            DungeonBuilder.Instance.mapdata = new DungeonBuilder.DataMapRandom();
        }
        else
        {
            DungeonBuilder.Instance.ResetIndex();
        }
